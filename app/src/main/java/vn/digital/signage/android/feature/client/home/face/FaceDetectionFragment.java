...
import vn.digital.signage.android.feature.client.home.face.widget.BarcodeTrackerFactory;
import vn.digital.signage.android.feature.client.home.face.widget.FaceTrackerFactory;
import vn.digital.signage.android.feature.client.home.face.widget.camera.CameraSourcePreview;
...
public class FaceDetectionFragment extends Fragment implements BaseFaceDetectionFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        final View view = inflater.inflate(R.layout.fragment_face_detection, container, false);
        ...
        if (rc == PackageManager.PERMISSION_GRANTED) {
            Log.i(TAG, "onCreateView - createCameraSource");
            createCameraSource();
        } else {
    ...
    private void requestCameraPermission() {
        ...
        Snackbar.make(mGraphicOverlay, R.string.face_detection_permission_camera_rationale,
                Snackbar.LENGTH_INDEFINITE)
                .setAction(R.string.face_detection_btn_ok, listener)
                .show();
    }
    ...
    private void createCameraSource() {
        ...
        FaceTrackerFactory faceFactory = new FaceTrackerFactory(mGraphicOverlay, SMRuntime.getInstance());
        ...
        if (!multiDetector.isOperational()) {
            ...
            if (hasLowStorage) {
                Toast.makeText(getActivity(), R.string.face_detection_low_storage_error, Toast.LENGTH_LONG).show();
                Log.w(TAG, getString(R.string.face_detection_low_storage_error));
            }
        }
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (grantResults.length != 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
            ...
            Log.i(TAG, "onRequestPermissionsResult - createCameraSource");
            createCameraSource();
            return;
        }
        ...
        builder.setTitle("Multitracker sample")
                .setMessage(R.string.face_detection_no_camera_permission)
                .setPositiveButton(R.string.face_detection_btn_ok, listener)
                .show();
    }
