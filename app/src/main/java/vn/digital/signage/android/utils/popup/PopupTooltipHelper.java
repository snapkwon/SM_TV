package vn.digital.signage.android.utils.popup;
...
public class PopupTooltipHelper {
    ...
    public PopupTooltipHelper(Context context, String text, int viewResource) {
        mContext = context;
        mWindow = new PopupWindow(context);
        mWindowManager = (WindowManager) context.getSystemService(Context.WINDOW_SERVICE);
        LayoutInflater layoutInflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        setContentView(layoutInflater.inflate(viewResource, null));
        mHelpTextView = (TextView) mView.findViewById(R.id.view_popup_text);
        mUpImageView = (ImageView) mView.findViewById(R.id.view_popup_arrow_up);
        mDownImageView = (ImageView) mView.findViewById(R.id.view_popup_arrow_down);
        mHelpTextView.setMovementMethod(ScrollingMovementMethod.getInstance());
        mHelpTextView.setSelected(true);
    }

    public PopupTooltipHelper(Context context) {
        this(context, "", R.layout.view_popup);
    }

    public PopupTooltipHelper(Context context, String text) {
        this(context);
        setText(text);
    }
    ...
    public void show(View anchor) {
        ...
        whichArrow = ((onTop) ? R.id.view_popup_arrow_down : R.id.view_popup_arrow_up);
        requestedX = anchorRect.centerX();
        View arrow = whichArrow == R.id.view_popup_arrow_up ? mUpImageView
                : mDownImageView;
        View hideArrow = whichArrow == R.id.view_popup_arrow_up ? mDownImageView
                : mUpImageView;
