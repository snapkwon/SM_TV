...
public class AppUpdateServiceConfiguration {
    ...
    public static class Build {
        ...
        private boolean ignoreServerPolicy = true;
        ...
        /*** 是否忽略手机和操作系统的信息 ***/
        private boolean ignoreRequestOSInfo = true;
        /*** 是否忽略App的信息 ***/
        private boolean ignoreRequestAppInfo = true;
        /*** 是否忽略分辨率的信息 ***/
        private boolean ignoreRequestDisplayInfo = true;
