...
public class AutoUpgradeDelegate implements AppUpdate {
    ...
    protected Version checkUpdateInTask(ContextWrapper wrapper) {
        ...
        try {
            ...
            Log.i("retrofit - log request", info.getUpdateUrl());
            response = (String) responseDelivery.submitRequest(info);
            Log.i("retrofit - log response", response);
        } catch (Throwable exp) {
    ...
    public static void installAPK(ContextWrapper wrapper, File apk) {
        ...
        //installApk0(wrapper, apk);
        //installApk1(wrapper, apk);
        // installApk2(wrapper, apk);
        // installApk4(wrapper, apk);
    }

    private static void installApk0(ContextWrapper wrapper, File apk) {
    ...
    private static void installApk1(ContextWrapper wrapper, File apk) {
        Context context = wrapper.getContext();
    ...
    public static void installApk2(ContextWrapper wrapper, File apk) {
        final String libs = "LD_LIBRARY_PATH=/vendor/lib:/system/lib ";

        try {
            final String commands = libs + "pm install -r " + apk.getAbsolutePath();
    ...
    public static void installApk3(ContextWrapper wrapper, File apk) {
       /* try {
    ...
    public static void installApk4(ContextWrapper wrapper, File apk) {
